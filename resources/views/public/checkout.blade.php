...
<!-- After added by Tarun -->
<input type="hidden" name="itemName" value="{{$report->report_title}}">              
<input title="item_name" name="item_name" type="hidden" value="{{$report->report_title}}">                        
<input title="item_description" name="item_description" type="hidden" value="Description : {{$report->report_title}}">
<!-- End Append -->
            <div class="form-group">
