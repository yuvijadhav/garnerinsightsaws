    ...
    <div class="container">  
        ...
        <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
            <div class="product-upload-page-area bg-secondary section-space-bottom">
                <h3 class="title-section">Update Publisher</h3>
                <form id="personal-info-form" method="post" action="editPublisher" enctype='multipart/form-data'>
                    {{ csrf_field() }}
                    <input class="profile-heading" value="{{$publisher->publisher_id}}" name="publisher_id" type="hidden">
                    <div class="product-upload-wrapper inner-page-padding">
                        <div class="form-group upload-info-item {{ $errors->has('publisher_name') ? ' has-error' : '' }}"> 
                            ...
                            <div class="upload-info-field"> 
                                <input class="profile-heading" value="{{$publisher->publisher_name}}" placeholder="Enter Publisher Name ..." name="publisher_name" type="text">
                        ...
                        <div class="form-group upload-info-item"> 
                            ...
                            <div class="upload-info-field">
                                <img src="storage/app/{{$publisher->publisher_image}}" class="img-thumbnail" alt="Cinque Terre" width="304" height="236">
                            </div>
                        </div>
                        <div class="form-group upload-info-item {{ $errors->has('publisher_image') ? ' has-error' : '' }}"> 
                            <div class="upload-info-title"> 
                                <h4>Publisher Image<span>*</span></h4>
                            </div>
                            <div class="upload-info-field"> 
