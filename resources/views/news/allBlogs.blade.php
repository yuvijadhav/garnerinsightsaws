                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-3">
                            <div class="page-controls-sorting">
                                <div class="dropdown">
                                    <button class="btn sorting-btn dropdown-toggle" type="button" data-toggle="dropdown">All Blogs</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3">
                            <div class="layout-switcher">
                                <a class="sidebar-full-width-btn add-button message-text" href="addBlog">Add Blog</a>
                            </div>
                        </div>
                    </div>
                </div>
