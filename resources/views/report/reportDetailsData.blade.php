...
$tableData = $report->reportDetails['long_content'];
...
$figureData = $report->reportDetails['table_figures'];
    ...
    <div class="container">
        <div class="pagination-wrapper">
            <ul>
                ...
                <li><a href="{{config('app.baseURL')}}/categories/{{$report->subCategory->sub_category_description}}">{{$report->subCategory->sub_category_name}}</a><span>  >></span></li>
                    ...
                    <div class="">
                        <div class="row">
                            <div class="col-lg-2 col-md-3 col-sm-3">
                                <div class="image">
                                    <img height="160px;" width="115px" src="{{config('app.baseURL')}}/storage/app/{{$report->subCategory->sub_category_image}}">
                            ...
                            <div class="col-md-10 report-right">
                                ...
                                <div class="info">
                                    ...
                                    <span class="verticalLine">Region : {{$report->region['name']}}</span>
                                    <span class="verticalLine">{{$report->reportdetails['report_pages']}} Pages</span>
                                    <span class="verticalLine">{{$report->publisher->publisher_name}}</span>                           
                                </div>
                            </div>
                        </div>                    
                    </div>    
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="product-upload-page-area bg-secondary section-space-bottom">
                                                ...
                                                <form id="personal-info-form" method="post" action="{{config('app.baseURL')}}/addEnquiryReport" enctype='multipart/form-data'>
                                                    ...
                                                    <input type="hidden" value="{{$report->reportdetails['report_pages']}}" name="report_pages" readonly />
                    ...
                    <form action="{{Config('app.baseURL')}}/postPayment" method="post">
                        ...
                        <div class="bottom-padding">
                            <ul style="margin-top:10px;">
                                @if($report->reportdetails["single_price"]!= "")
                                <li id='li-top'>
                                    <fieldset class="form-group" id="lic-type-margin">
                                        <input type="radio" id="buy1" value="{{$report->reportdetails["single_price"]}}" name="cost" selected>
                                        <label for="radio1" id="labuy1" class="text-black">SINGLE USER LICENSE - $ {{$report->reportdetails["single_price"]}} </label>
                                ...
                                @endif
                                @if($report->reportdetails['corporate_price']!="")
                                <li id='li-top'>
                                    <fieldset class="form-group" id="lic-type-margin">
                                        <input type="radio" id="buy2" value="{{$report->reportdetails['corporate_price']}}" name="cost">
                                        <label for="radio2" id="labuy2" class="text-black">MULTI USER LICENSE - $ {{$report->reportdetails['corporate_price']}} </label>
                                ...
                                @endif
                                @if($report->reportdetails['enterprise_price']!="")  
                                <li id='li-top'>
                                    <fieldset class="form-group" id="lic-type-margin">
                                        <input type="radio" id="buy3" value="{{$report->reportdetails['enterprise_price']}}" name="cost">
                                        <label for="radio3" id="labuy3" class="text-black">ENTERPRISE LICENSE - $ {{$report->reportdetails['enterprise_price']}} </label>
...
<script type="text/javascript">
    ...
    $("#sub_category_id").text(report.sub_category.sub_category_name);
    $("#publisher_id").text(report.publisher.publisher_name);
