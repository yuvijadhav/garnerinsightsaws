    ...
    <div class="container">  
        ...
        <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 margin-bottom-15">
            <div class="product-upload-page-area bg-secondary section-space-bottom">
                <h3 class="title-section">Update Press Release</h3>
                <form id="personal-info-form" method="post" action="editPressRelease" enctype='multipart/form-data'>
                    {{ csrf_field() }}
                    <input class="profile-heading" value="{{$article->article_id}}" name="article_id" type="hidden">
                    <div class="product-upload-wrapper inner-page-padding">
                        <div class="form-group upload-info-item {{ $errors->has('article_title') ? ' has-error' : '' }}"> 
                            ...
                            <div class="upload-info-field"> 
                                <input class="profile-heading" value="{{$article->article_title}}" placeholder="Enter Press Release title..." name="article_title" type="text">
                        ...
                        <div class="form-group upload-info-item"> 
                            ...
                            <div class="upload-info-field">
                                <img src="storage/app/{{$article->article_image}}" class="img-thumbnail" alt="Cinque Terre" width="304" height="236">
                            </div>
                        </div>
                        ...
                        <div class="form-group upload-info-item {{ $errors->has('article_url') ? ' has-error' : '' }}"> 
                            ...
                            <div class="upload-info-field"> 
                                <input class="profile-heading" value="{{$article->article_url}}" placeholder="Enter Press Release URL..." name="article_url" type="text">
